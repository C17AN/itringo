          ...
          questions: [
            {
              ...
              options: [
                { id: 'opt1', text: '서버 크래시' },
                { id: 'opt2', text: '업스트림 서버로부터 잘못된 응답 수신' },
                { id: 'opt3', text: '페이지를 찾을 수 없음' },
                { id: 'opt4', text: '권한 없음' },
              ],
              correctAnswerId: 'opt2',
            ...
            },
            {
              ...
              options: [
                { id: 'opt1', text: '클라이언트 연결 끊김' },
                { id: 'opt2', text: '업스트림 서버가 제때 응답하지 않음' },
                { id: 'opt3', text: 'DNS 조회 실패' },
                { id: 'opt4', text: '데이터베이스 가득 참' },
              ],
              correctAnswerId: 'opt2',
